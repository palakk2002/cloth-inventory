...
const menuItems = [
    ...
    { icon: Factory, label: 'Production Master', path: '/admin/production' },
    { icon: Clock, label: 'Material Received', path: '/admin/material-received' },
    { icon: Scissors, label: 'Cutting Stage', path: '/admin/cutting' },
    { icon: CheckCircle, label: 'Finishing Stage', path: '/admin/finishing' },
    { icon: Store, label: 'Shops', path: '/admin/shops' },
    { icon: Send, label: 'Dispatch', path: '/admin/dispatch' },
    { icon: BarChart3, label: 'Sales Overview', path: '/admin/sales-overview' },

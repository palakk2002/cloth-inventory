...
export default function StoreAuthLayout({ children }) {
    return (
        ...
        >
            {/* Background Blobs — desktop + mobile */}
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#1E3A56]/10 rounded-full blur-[100px] animate-float opacity-30" />
            ...
            {/* Footer text — hidden on mobile (shown inside mobile card instead) */}
